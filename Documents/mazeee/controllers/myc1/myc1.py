...
GREEN_THRESHOLD = 1.5
BLUE_THRESHOLD = 1.5
MIN_OBJECT_SIZE = 40000 # minimum size for the object to be detected
...
while robot.step(TIME_STEP) != -1:
    ...
    if is_front_touching:
        ...
        left_speed, right_speed, msg = MAX_SPEED, 0.75 * MAX_SPEED, "Left obstacle detected, shifting right"
    elif is_right_touching:
        left_speed, right_speed, msg = 0.75 * MAX_SPEED, MAX_SPEED, "Right obstacle detected, shifting left"
